...
switch ($_GET["op"]) {
    ...
    case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
            ...
            <button class="btn btn-primary btn-xs" onclick="mostrar('.$reg->id.')">
            ...
            '<button class="btn btn-primary btn-xs" onclick="activar('.$reg->id.')">
            <i class="fa fa-check"></i>Activar</button>',
