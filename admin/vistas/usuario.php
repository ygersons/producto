        ...
        <div class="col-xl-12 col-md-12 col-lg-12">
          <div class="card bg-gradient-gray border-0">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
 <center> <h3 class="box-title" style="font-size: 50px "><b>Usuarios del Sistema</b></h3></center>

    <button class="btn btn-primary" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Agregar Usuario</button>
